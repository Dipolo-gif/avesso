...
for(const file of ['dist/app.js','dist/commerce.js','dist/motion-ui.js','dist/studio-3d.js','dist/studio-placement.js','dist/frame-guard.js','server.mjs'])execFileSync(process.execPath,['--check',file]);
